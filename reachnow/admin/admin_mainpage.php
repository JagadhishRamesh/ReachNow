...
<body>
<ul >
  <li><a class="active" href="admin_mainpage.php">All Requests</a></li>
 ...
 <li style=" float: right;"><a href="admin_logout.php" onclick="return confirm('Are you sure to logout?');">Sign Out</a></li>
  ...
  <br><br>
<?php
  $select_sql = "SELECT requestid,name,email,phone_number,comments,approver_remarks,status FROM new_user_requests";
